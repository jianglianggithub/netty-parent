...
public abstract class ResourceLeakDetectorFactory {
     ...
     * @return a new instance of {@link ResourceLeakDetector}   DefaultResourceLeakDetectorFactory
     */
    ...
    private static final class DefaultResourceLeakDetectorFactory extends ResourceLeakDetectorFactory {
        ...
        DefaultResourceLeakDetectorFactory() {
            ...
            try {
                customLeakDetector = SystemPropertyUtil.get("io.netty.customResourceLeakDetector"); // 如果没有指定 内存泄漏追踪器 默认使用netty得
